...
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
RedissonLock uses LUA-script to set lock value because locking is much complicated than just a setnx-command. It doesn't use setnx but checking for previous value is present in script. As LUA-script executes atomically we can use non-atomic commands in script.
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
How many cores do you have? If you want 1000 mutliple thread works as fast as single in 1ms when you need a 1000 cores.
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
Possible PublishSubscribe race-condition · Issue #724 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
DistributedLock - Lock is getting acquired by multiple threads. · Issue #738 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
Redisson get api  is very slow !!!! · Issue #753 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
public  void getmodulemapTime() throws Exception
{
long w_start_time = System.nanoTime();
String w_existingMap = (String)CacheService.get(CacheConstants.CACHEKEY.MODULE_CKEY_GLOBAL_MAP, "MODULEMANAGER_GLOBAL_MODULE_MAP_KEY");
long w_end_time = System.nanoTime();
double w_difference = (w_end_time - w_start_time)/1000000;
System.out.println("Get Time in ms for MODULE *****" + w_difference);
}
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

https://github.com/redisson/redisson/issues/755
Documentation on locks · Issue #755 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
i.e.
Node1:
Lock lock = redisson.getLock("LOCK-1");
lock.lock();
try{
  //do something but the jvm is hard killed externally (power loss, reboot, etc)
} finally {
 lock.unlock();
}

Node2: called after node1 enters the lock, but before node 1 dies
Lock lock = redisson.getLock("LOCK-1");
lock.lock();
try{
  //do something
...
14:42:11.742 [redisson-netty-1-6] WARN  i.n.util.concurrent.DefaultPromise - An exception was thrown by org.
...
add attribute distribution lock to "LiveObject" · Issue #803 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
Using locks to synchronize master/standby functionality? · Issue #907 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
https://github.com/redisson/redisson/issues/955
 what is the best way  to store a MultiLock between web request? · Issue #955 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
how to use redLock in cluster · Issue #956 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
Config config = new Config();
config.useClusterServers().addNodeAddress("redis://xxx:7000", "redis://xxxx:7001","redis://xxx:7002", "redis://xxxx:7003","redis://xxx:7004", "redis://xxxx:7005");
...
RedissonClient redisson4 = Redisson.create(config);
RedissonClient redisson5 = Redisson.create(config);
RedissonClient redisson6 = Redisson.create(config);
String lockName = "test";
RLock lock1 = redisson1 .getLock(lockName);
RLock lock2 = redisson2 .getLock(lockName);
RLock lock3 = redisson3 .getLock(lockName);
RLock lock4 = redisson4 .getLock(lockName);
RLock lock5 = redisson5.getLock(lockName);
RLock lock6 = redisson5.getLock(lockName);
RedissonRedLock lock = new RedissonRedLock(lock1, lock2, lock3, lock4, lock5, lock6);
Thanks!
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

https://github.com/redisson/redisson/issues/962
Add RLockReactive · Issue #962 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
No description provided.
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

https://github.com/redisson/redisson/issues/963
Add RReadWriteLockReactive · Issue #963 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
No description provided.
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

https://github.com/redisson/redisson/issues/966
why not poll a RedisConnection directly without using connectionFuture · Issue #966 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
Add RSemaphoreReactive · Issue #977 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
No description provided.
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

https://github.com/redisson/redisson/issues/987
RScoredSortedSet race condition with Redis cluster · Issue #987 · redisson/redisson · GitHub
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
In our application code we have something like this..
 redisSet.addAsync(latestScore, playerId)
                .thenAcceptAsync(r -> {
...
redisSet.addAndGetAsync(latestScore, playerId) 
                .thenAcceptAsync((r, newRank)) -> { <-- BiConsumer?
                    .....
